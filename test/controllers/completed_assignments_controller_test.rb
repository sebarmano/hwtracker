...
class CompletedAssignmentsControllerTest < ActionController::TestCase
  ...
  test "should create completed_assignment" do
    assert_difference('CompletedAssignment.count') do
      post :create, completed_assignment: { assignment_id: @completed_assignment.assignment_id, student_id: @completed_assignment.student_id }
    end
  ...
  test "should update completed_assignment" do
    patch :update, id: @completed_assignment, completed_assignment: { assignment_id: @completed_assignment.assignment_id, student_id: @completed_assignment.student_id }
    assert_redirected_to completed_assignment_path(assigns(:completed_assignment))
  end
